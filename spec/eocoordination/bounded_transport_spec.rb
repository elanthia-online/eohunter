...
require_relative '../../scripts/eocoordination/server'
require_relative '../../scripts/eocoordination/client'

RSpec.describe 'Bounded coordination-library transport' do
  let(:server_class) { EO::Coordination::Transport::Server }
  let(:client_class) { EO::Coordination::Transport::Client }
  let(:frame) { EO::Coordination::Transport::BoundedFrame }
  ...
  # @return [EO::Coordination::Transport::Server]
